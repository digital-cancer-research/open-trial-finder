...
variant.nodes <- rbind(variant.nodes, unique(dplyr::select(variants, "id" = "gene")))
...
variant.nodes$node.colour <- "red"
gene.nodes$node.colour <- "blue"
drug.nodes$node.colour <- "green"
study.nodes$node.colour <- "black"
