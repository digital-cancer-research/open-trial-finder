...
## indicate which criteria relate to mutations, fusions
eligibilities$change[grep(pattern = mutantPattern, x=eligibilities$criteria, ignore.case = T)] <- "MUTATION"
...
```{r index criteria with gene names}
...
## loop through each criterion that contains a mutant/fusion pattern
