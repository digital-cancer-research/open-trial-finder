...
"')
  ...
  AND f.status IN ('Not yet recruiting','Recruiting')")
...
amplification.eligibilities <- indexOnPattern(eligibilities = eligibilities, pattern = " amplifi|overexpress", wordRange = 5, featureLabel = "amplification")
