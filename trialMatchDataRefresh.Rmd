...
## replace periods in column names (if any) with underscore for compatibility with SQL
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(humanGenes) <- gsub(pattern = "\\.", replacement = "_", x=names(humanGenes))
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(variants) <- gsub(pattern = "\\.", replacement = "_", x=names(variants))
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(evidence) <- gsub(pattern = "\\.", replacement = "_", x=names(evidence))
...
for(i in 1:nrow(conditionSynonyms)) {
  synonym <- as.character(conditionSynonyms$condition_synonyms[i])
  targetCondition <- as.character(conditionSynonyms$controlled_cancer_type[i])
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(cancerStudies) <- gsub(pattern = "\\.", replacement = "_", x=names(cancerStudies))
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(drugs.targets) <- gsub(pattern = "\\.", replacement = "_", x=names(drugs.targets))
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(indexed.eligibilities) <- gsub(pattern = "\\.", replacement = "_", x=names(indexed.eligibilities))
...
## replace periods in column names (if any) with underscore for compatibility with SQL
names(edges) <- gsub(pattern = "\\.", replacement = "_", x=names(edges))
