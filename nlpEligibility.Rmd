...
eligibilities_temp <- eligibilities

# eligibilities_temp <- unique(filter(eligibilities_temp, nct_id %in% example_studies))

eligibilities_temp <- unique(dplyr::select(eligibilities_temp, criterion_sentence_index, sentences))
