...
example_criteria <- dplyr::select(example_criteria, nct_id, criteria, criterion_type)
...
## inner join
example_criteria <- unique(merge(x=example_criteria, by.x = "tokens", all.x = FALSE, y = unique(dplyr::select(NCIt_cellMolecularDysfunction, Synonyms_stem, ID,PreferredTerm, Class)), by.y = "Synonyms_stem"))
