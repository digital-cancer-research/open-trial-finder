...
* As of `r today`, for `r configuration$country` this includes **`r length(unique(cancerStudies$nct_id))` cancer studies**.  
...
* After mapping to preferred terms for cancer types, **`r length(unique(cancerStudies$nct_id))` studies remain**  
