...
open_cancerStudies_view <- unique(dplyr::select(cancerStudies, nct_id, brief_title, overall_status, condition, "Refresh.date" = "refresh_date","matching.condition" = "condition", "TARGET.condition" = "controlled_cancer_type"))
...
open_cancerStudies_view <- unique(merge(x=open_cancerStudies_view, 
                                   by.x = "nct_id", 
                                   y = dplyr::select(uk_facilities, nct_id, "site_name"="facility_name", "site_status" = "facility_status", "locations"="city","postcode"="longitude", "postcode.lat"="latitude", "postcode.long"="longitude", "lat"="latitude", "long"="longitude"), 
                                   by.y = "nct_id"))
...
# open_cancerStudies_view <- unique(dplyr::select(open_cancerStudies_view, interventions, locations, postcode, nct_id, brief_title, overall_status,"condition"="matching.condition", site_name, site_status, ))
```
