...
# mutantIndices <- grep(pattern = "mutat|mutant|defect|deficien|alter|loss of function|loss-of-function", x=kwic_genes$context, ignore.case = TRUE)

# mutation_eligibilities <- kwic_genes[mutantIndices, ]

## add a column to indicate matched feature
# mutation_eligibilities$feature <- "mutation"
...
```{r index on mutations}
## for example 
# head(get_context_mod(dataframe = eligibilities, textcolumn = "sentences", docid_field = "criterion_sentence_index", pattern = c("mutat", "\\bdeficien")),20)


## can do something like this....
## pass a list of human gene aliases as the pattern to detect...

# head(quanteda::kwic(x=eligibilities_subset$sentences, pattern=humanGenes$Aliases, case_insensitive=FALSE))
