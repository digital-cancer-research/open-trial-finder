...
**CONTINUTE FROM HERE ON THURSDAY**    
...
kwic_interventions <- unique(merge(x=kwic_interventions, by.x="NCIt_id", all.x=TRUE, y=unique(dplyr::select(drugs_targets, NCIt_code, TARGET_SYMBOL)), by.y = "NCIt_code", incomparables = NA))
