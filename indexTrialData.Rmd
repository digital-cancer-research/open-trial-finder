...
drugs_targets <- unique(dplyr::select(NCIt_to_CHEMBL, "NCIt_code"="code", TARGET_SYMBOL, action_type, mechanism_of_action))
...
iuphar_processed$mechanism_of_action <- NA
...
**NEED DEAL WITH REDUNDANCY DUE TO IUPHAR HAVING SAME DRUG, SAME TARGET BUT MISSING MECHANISM OF ACTION**    
