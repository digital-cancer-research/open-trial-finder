...
## create as a table in database
dbWriteTable(conn = sqlite_con,name = "population_features", value = population_features, overwrite=TRUE)
...
tryCatch(
    { download.file(url=postcodesURL, destfile = destPostcodesFilename)
        ...
        ## create as a table in database
        dbWriteTable(conn = sqlite_con,name = "uk_postcodes", value = uk_postcodes, overwrite=TRUE)
    }, error=function(cond) {
...
if(!exists("uk_postcodes")) {
  uk_postcodes <- dbGetQuery(sqlite_con, "SELECT * FROM uk_postcodes")
}
toc()
...
## create as a table in database
dbWriteTable(conn = sqlite_con,name = "local_open_studies", value = local_open_studies, overwrite=TRUE)
...
## create as a table in database
dbWriteTable(conn = sqlite_con,name = "indexed_eligibilities_view", indexed_eligibilities_view , overwrite=TRUE)
...
## create as a table in database
dbWriteTable(conn = sqlite_con,name = "open_cancerStudies_view", open_cancerStudies_view, overwrite=TRUE)
...
## create as a table in database
dbWriteTable(conn = sqlite_con,name = "scoredMatches_view", scoredMatches_view , overwrite=TRUE)
