...
### Shortlisted studies (`r renderText(numberSelectedRows())`)
...
output$info = renderPrint({
    #length(list(rows = input$datatable_rows_selected))
    length(input$datatable_rows_selected)

  })


## define a reactive value that will hold number selected rows
numberSelectedRows <- reactive({
  number <- length(input$datatable_rows_selected)
  ## return value
  number
})
...
#verbatimTextOutput(numberSelectedRows())
renderPrint(numberSelectedRows())
