...
# output$datatable <- DT::renderDT(dplyr::select(formattedTable(), -ID), escape = 5, 
#                                  options = list(ordering=F, paging = FALSE, scrollX = TRUE, scrollY = "450px", scrollCollapse = TRUE, columnDefs = list(list(width = '500px', targets = list(5)))) )

# output$datatable <- DT::renderDT(dplyr::select(formattedTable(), -ID), escape = 5, options = list(ordering=F,                                                                                           paging = FALSE,                                                                   scrollX = TRUE, 
...
output$shortlistTable <- DT::renderDT(dplyr::select(shortlist(), -ID), rownames=FALSE, escape = 5, options = list(ordering=F,                                                                                           paging = FALSE,                                                                   scrollX = TRUE, 
      scrollY = "450px",                                                                          scrollCollapse = TRUE, 
      autoWidth = TRUE,
      columnDefs = list(list(width = '500px', targets = list(5)))
      #columnDefs = list(list(targets=c(5), visible=TRUE, width='30%'))
