...
## define a variable that will hold alterations from URL
#urlAlterations <- NA
...
## URL when running locally is http://127.0.0.1:3831/TRIAL_MATCH_SHINY.Rmd

## can test by manually changing URL to e.g. 
