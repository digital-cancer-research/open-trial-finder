...
output$downloadShortlist <- downloadHandler(
      ...
      content = function(file) {
        ...
        shortlistTable$datetime <- Sys.time()
        ## capture the cancer type passed in url
        shortlistTable$urlCancerType <- urlValues$CancerType
        ...
        shortlistTable$urlAlterations <- NA
        if(!is.null(urlValues$alterations)) {
        ...
        dbWriteTable(conn = con2,name = "downloaded", value = shortlistTable, append=TRUE)
        dbDisconnect(con2) 
